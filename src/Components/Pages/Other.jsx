            ...
            <div className={styles.homepageContent}>
                ...
                <div className={styles.homepageText}>
                    <p className={styles.homepageParagraph}>
                        ...
                        counting individual items) and strengthens the connection between intuitive estimation of
                        quantities and
                        their corresponding symbolic numbers, leading to significant improvements in arithmetic in a
                        short time. The Digits game is effective because it bridges the gap between non-symbolic number
                        sense
                    ...
                    <p className={styles.homepageParagraph}>
                        ...
                        <br></br>
                        Ferres-Forga, N., Halberda, J., Batalla-Ferres, A., & Bonatti, L. L. (2022). Improving
                        Mathematics
                        Performance in 7-Year-Old Children: Training the Mapping From Estimated Quantities to Arabic
                        Digits.
                    ...
                    <p className={styles.homepageParagraph}>
                        ...
                        proficiency. The limitations of the study version included a fixed number of sessions (only 8
                        were
                        created) and the use of static images for the collections of items. There were no different
                        levels,
                        as it was specifically designed for 7 to 8 year-olds. In fact, considering the narrow scope of
                        the
                        study’s requirements, the game wasn’t even programmed with a complex computer language, but
                        rather
                        through a graphical interface to simplify its creation.
                    </p>
                    <p className={styles.homepageParagraph}>
                        In contrast, the version of Digits presented here has been fully programmed to allow for
                        unlimited
                        practice sessions and is suitable for different age groups. It features dynamically generated
                        images, all while adhering to the same scientific principles that activate the Approximate
                        Number
                        System (ANS).
                    </p>
                </div>
                ...
                <div className={styles.homepageText}>
                    <p className={styles.homepageParagraph}>
                        ...
                        However, continued practice will further reinforce the link between estimating quantities and
                        identifying
                    ...
                    <p className={styles.homepageParagraph}>
                        ...
                        <br></br>
                        Before playing the game, make sure to have the adequate profile selected. This way, the
                        statistics
                    ...
                    <p className={styles.homepageParagraph}>
                        ...
                        on the screen for one second, followed by three Arabic digits. Players must select the digit
                        that
                    ...
                    <p className={styles.homepageParagraph}>
                        ...
                        number of items on the screen becomes larger. Additionally, the difficulty increases between
                        runs as the
                    ...
                    <p className={styles.homepageParagraph}>
                        ...
                        advancing from standard to advanced level (though you can stay at standard level as long as you
                        prefer),
                        check the statistics from your last session. If the percentage of correct answers in the last
                        run is
                        below 33% (chance level), or if the percentage of correct answers in the overall session is
                        below
                    ...
                    <ul className={styles.homepageList}>
                        <li className={styles.homepageListItem}>
                            ...
                            figures (1, 2, 3, 4, ...) for numbers from 1 to 10. Reading the number words is not
                            necessary,
                        ...
                        <li className={styles.homepageListItem}>
                            ...
                            To practice at this level, the child must be able to correctly associate
                            number words (e.g., one, two, three, four—spoken, not written) with their corresponding
                            figures (1, 2, 3, 4, ...) for numbers from 1 to 15. Reading the number words is not
                            necessary,
                            only recognizing them when spoken. Understanding the actual meaning of these numbers is
                            also not required.
                        </li>
                ...
                <div className={styles.homepageText}>
                    <p className={styles.homepageParagraph}>
                        Our <a href="/privacyPolicy.html" target="_blank"
