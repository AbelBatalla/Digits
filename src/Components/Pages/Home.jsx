...
const Home = () => {
    ...
    <>
        <div className={styles.homepageContent}>
            ...
            <p className={styles.homepageText}>
                Improve your mathematical abilities by training the mapping from estimated quantities to Arabic digits. This connection is essential because mathematical thinking involves both an intuitive sense of numbers, known as the Approximate Number System (ANS), and the precise symbolic system of Arabic digits used for arithmetic operations. <a href="https://doi.org/10.5964/jnc.8075">Research</a> shows that this type of training helps children improve their ability to perform symbolic additions and subtractions, offering benefits beyond regular practice. In particular, it enhances arithmetic abilities by building a more solid foundation for understanding and using numbers. The game is designed to be engaging and effective, offering a fun way to improve math skills.
            </p>

            <p className={styles.homepageText}>
                If you’re an educator, parent, researcher or student interested in enhancing math performance, you, your students, children or participants can play the Digits game for free  <Link to="/digits">here</Link>. Please log in to access the game and track your progress.
            </p>
        </div>
    </>
    )
